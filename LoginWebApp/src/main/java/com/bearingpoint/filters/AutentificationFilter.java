 ...
 */
package com.bearingpoint.filters;
...
public class AutentificationFilter implements Filter {
	...
	// Create wrappers for the request and response objects.
        ...
        try {
            ...
            log("suntem in filtru pentru URL cerut "+wrappedRequest.getServletPath());
            
            
            HttpSession session =((HttpServletRequest)request).getSession();// da sesiunea curenta
                         
            
        
//        if (session==null || session.getAttribute("siteUser")==null) {
//            log("cmsshowedithomeservlet vrem la showlogin.html");
//            
//            String page="/ACentricSite/showlogin.html";
//            request.setAttribute("error","please log in first!" );
//            
//            //((HttpServletRequest)request).getRequestDispatcher(page).forward((HttpServletRequest)request, (HttpServletResponse)response);
//            ((HttpServletResponse)response).sendRedirect(page);
//           //return;
//
//
////            problem = new Exception("Problema de autentificare");
////            throw  problem;
////            
//        }
