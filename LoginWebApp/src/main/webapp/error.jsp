...
<html>
    ...
    <link href="../style/css/font-awesome.min.css" rel="stylesheet" type="text/css">
       ...
       <!--Custom Fonts--> 
    <link href="../style/css/costumnCss.css" rel="stylesheet" type="text/css">
  ...
  <div class="row">
    <div class="span12">
      <div class="hero-unit center">
          ...
          <a href="../home.html" class="btn btn-large btn-info"><i class="icon-home icon-white"></i> Take Me Home</a>
        </div>
        <br />
